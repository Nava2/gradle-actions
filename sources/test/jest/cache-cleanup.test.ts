...
const gradleProvisioner = new GradleProvisioner(new GradleExecutableExecutor(), new CacheConfig(githubActionGradleEnv))
const cacheCleaner = new CacheCleaner(gradleProvisioner)
