...
import {DependencyGraphConfig, getActionId, setActionId} from '../../env/configuration'
...
export async function run(): Promise<void> {
    try {
        ...
        await dependencyGraph.setup(new DependencyGraphConfig(githubActionGradleEnv))
